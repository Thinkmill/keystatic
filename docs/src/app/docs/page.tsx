            ...
            <div className="grid gap-6 grid-cols-[auto,12rem]">
              <div>
                ...
                <p className="mt-6 text-lg text-stone-600">
                  ...
                  contributors who would prefer to write and manage content and
                  data in a UI that looks more like a CMS than VS Code.
                </p>
                ...
                <div className="relative rounded-lg p-5 bg-keystatic-gray w-full mt-6">
                  <blockquote className="text-stone-600">
                    <p className="flex gap-5">
                      <span>
                        We've been working on Keystatic for a while, but we're
                        at the very early stages of releasing Keystatic
                        publicly. Much more to come…
                      </span>
                    </p>
                  </blockquote>
                </div>
