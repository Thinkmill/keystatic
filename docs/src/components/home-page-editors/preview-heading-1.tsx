export function PreviewHeading1(props: any) {
  return (
    <h1 className="font-extrabold text-3xl sm:text-4xl md:text-5xl">
      {props.fields.plainLine1.element}
      {props.fields.plainLine2.element}
      <span className="relative">
        ...
        <span className="relative">{props.fields.hilight.element}</span>
      </span>
    </h1>
  );
}
