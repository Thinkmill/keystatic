  ...
  return (
    ...
    >
      ...
      <span className="relative mx-auto block max-w-5xl px-6 py-6 md:py-10">
        <span className="text-pretty flex items-center justify-center gap-4 text-center text-base text-white md:text-lg">
          <span>
          ...
          <svg
            ...
            viewBox="0 0 20 20"
            fill="currentColor"
            className="size-6 hidden shrink-0 transition group-hover:translate-x-1 lg:block"
            aria-hidden="true"
          >
            <path
              fill-rule="evenodd"
