export const CONTENT = {
  branches: [
    'Git branches are a way to work on multiple versions of a project simultaneously. Each branch is a separate line of development, allowing multiple people to work on the same project without interfering with each other.',
