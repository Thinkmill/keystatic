...
export const tokenSchema = {
  ...
  color: {
    global: {
      black: 'var(--ksv-color-global-black)',
      white: 'var(--ksv-color-global-white)',
    },
    scale: {
      ...
      amber12: 'var(--ksv-color-scale-amber12)',
      ...
      green12: 'var(--ksv-color-scale-green12)',
      ...
      indigo12: 'var(--ksv-color-scale-indigo12)',
      ...
      pink12: 'var(--ksv-color-scale-pink12)',
      ...
      purple12: 'var(--ksv-color-scale-purple12)',
      ...
      red12: 'var(--ksv-color-scale-red12)',
      ...
      slate12: 'var(--ksv-color-scale-slate12)',
    },
    alias: {
  ...
  fontsize: {
    scale: {
      '25': 'var(--ksv-fontsize-scale-25)',
      '50': 'var(--ksv-fontsize-scale-50)',
      '75': 'var(--ksv-fontsize-scale-75)',
      '100': 'var(--ksv-fontsize-scale-100)',
      '150': 'var(--ksv-fontsize-scale-150)',
      '200': 'var(--ksv-fontsize-scale-200)',
      '300': 'var(--ksv-fontsize-scale-300)',
      '400': 'var(--ksv-fontsize-scale-400)',
      '500': 'var(--ksv-fontsize-scale-500)',
      '600': 'var(--ksv-fontsize-scale-600)',
      '700': 'var(--ksv-fontsize-scale-700)',
      '800': 'var(--ksv-fontsize-scale-800)',
      '900': 'var(--ksv-fontsize-scale-900)',
    },
    text: {
      small: {
        size: 'var(--ksv-fontsize-text-small-size)',
        lineheight: 'var(--ksv-fontsize-text-small-lineheight)',
        capheight: 'var(--ksv-fontsize-text-small-capheight)',
        capheightTrim: 'var(--ksv-fontsize-text-small-capheight-trim)',
        baselineTrim: 'var(--ksv-fontsize-text-small-baseline-trim)',
      },
      regular: {
        size: 'var(--ksv-fontsize-text-regular-size)',
        lineheight: 'var(--ksv-fontsize-text-regular-lineheight)',
        capheight: 'var(--ksv-fontsize-text-regular-capheight)',
        capheightTrim: 'var(--ksv-fontsize-text-regular-capheight-trim)',
        baselineTrim: 'var(--ksv-fontsize-text-regular-baseline-trim)',
      },
      medium: {
        size: 'var(--ksv-fontsize-text-medium-size)',
        lineheight: 'var(--ksv-fontsize-text-medium-lineheight)',
        capheight: 'var(--ksv-fontsize-text-medium-capheight)',
        capheightTrim: 'var(--ksv-fontsize-text-medium-capheight-trim)',
        baselineTrim: 'var(--ksv-fontsize-text-medium-baseline-trim)',
      },
      large: {
        size: 'var(--ksv-fontsize-text-large-size)',
        lineheight: 'var(--ksv-fontsize-text-large-lineheight)',
        capheight: 'var(--ksv-fontsize-text-large-capheight)',
        capheightTrim: 'var(--ksv-fontsize-text-large-capheight-trim)',
        baselineTrim: 'var(--ksv-fontsize-text-large-baseline-trim)',
      },
    },
    heading: {
      small: {
        size: 'var(--ksv-fontsize-heading-small-size)',
        lineheight: 'var(--ksv-fontsize-heading-small-lineheight)',
        capheight: 'var(--ksv-fontsize-heading-small-capheight)',
        capheightTrim: 'var(--ksv-fontsize-heading-small-capheight-trim)',
        baselineTrim: 'var(--ksv-fontsize-heading-small-baseline-trim)',
      },
      regular: {
        size: 'var(--ksv-fontsize-heading-regular-size)',
        lineheight: 'var(--ksv-fontsize-heading-regular-lineheight)',
        capheight: 'var(--ksv-fontsize-heading-regular-capheight)',
        capheightTrim: 'var(--ksv-fontsize-heading-regular-capheight-trim)',
        baselineTrim: 'var(--ksv-fontsize-heading-regular-baseline-trim)',
      },
      medium: {
        size: 'var(--ksv-fontsize-heading-medium-size)',
        lineheight: 'var(--ksv-fontsize-heading-medium-lineheight)',
        capheight: 'var(--ksv-fontsize-heading-medium-capheight)',
        capheightTrim: 'var(--ksv-fontsize-heading-medium-capheight-trim)',
        baselineTrim: 'var(--ksv-fontsize-heading-medium-baseline-trim)',
      },
      large: {
        size: 'var(--ksv-fontsize-heading-large-size)',
        lineheight: 'var(--ksv-fontsize-heading-large-lineheight)',
        capheight: 'var(--ksv-fontsize-heading-large-capheight)',
        capheightTrim: 'var(--ksv-fontsize-heading-large-capheight-trim)',
        baselineTrim: 'var(--ksv-fontsize-heading-large-baseline-trim)',
      },
    },
  },
};
